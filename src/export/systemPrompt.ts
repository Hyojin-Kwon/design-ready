...
- For nodes with \`componentRef\`: there is NO component library to import. Render the component inline from its children in the tree — do NOT invent import statements or a component package. Add a \`// from: <ComponentName>\` comment to preserve the original component identity.
