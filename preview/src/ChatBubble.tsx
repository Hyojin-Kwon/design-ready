  ...
  >
    ...
    <span
      style={{
        ...
        fontWeight: 'var(--font-weight-ios-font-weight-semibold)' as React.CSSProperties['fontWeight'],
...
const TopNavigation: React.FC = () => (
  ...
  >
    ...
    <div style={{ display: 'flex', flexDirection: 'row', alignItems: 'center', gap: 3, flex: 1, minWidth: 0 }}>
    ...
    >
      <span
        style={{
          ...
          fontWeight: 'var(--font-weight-ios-font-weight-regular)' as React.CSSProperties['fontWeight'],
  ...
  >
    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: 5 }}>
      ...
      <div style={{ paddingLeft: 5 }}>
        <span
          style={{
            ...
            fontWeight: 'var(--font-weight-ios-font-weight-medium)' as React.CSSProperties['fontWeight'],
            color: 'var(--neutral-colors-linegray900)',
            display: 'block',
          }}
        >
      ...
      >
        {/* Bubble with tail */}
        <div style={{ position: 'relative' }}>
          {/* White tail — ico_1, anchored to top-left of bubble (x=0, y=0 in Figma) */}
          <Icon
            name="tailReceived"
            style={{
              position: 'absolute',
        ...
        <div style={{ display: 'flex', flexDirection: 'row', gap: 1 }}>
          ...
          <div
            style={{
              ...
              // TODO: token? — image fill placeholder
              backgroundColor: 'var(--neutral-colors-linegray300)',
              // TODO: token? — cornerRadius 12 (health: radius-token-missing)
              borderRadius: 12,
              overflow: 'hidden',
            }}
          >
            ...
            >
              ...
              <div style={{ width: 18, height: 17, flexShrink: 0, position: 'relative' }}>
                <svg
                  ...
                  style={{ position: 'absolute', left: 3, top: 2, filter: 'drop-shadow(0 0 2px rgba(0,0,0,0.25))' }}
                >
                  {/* exact Figma export path — LDS album_thumb_play Triangle */}
                  <path d="M8.31501 4.15824C8.97058 4.54521 8.97058 5.49361 8.31501 5.88057L1.50823 9.89846C0.841613 10.292 -9.53674e-05 9.81139 -9.53674e-05 9.0373V1.00152C-9.53674e-05 0.227426 0.841611 -0.253137 1.50823 0.140354L8.31501 4.15824Z" fill="var(--neutral-colors-linewhite)" />
                </svg>
              </div>
          ...
          <div
            style={{
              ...
              height: 120,
              backgroundColor: 'var(--neutral-colors-linegray300)',
              borderRadius: 12, // TODO: token? — radius-token-missing
            }}
          />
        </div>
        {/* Row 2 */}
...
const AddedItemMessage: React.FC = () => (
  <div style={{ display: 'flex', flexDirection: 'column' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'row', alignItems: 'flex-end' }}>
          ...
          >
            ...
            <div style={{ position: 'relative', width: 241, height: 241 }}>
              <div
                style={{
                  position: 'absolute', left: 0, top: 0, width: 120, height: 241,
                  backgroundColor: 'var(--neutral-colors-linegray300)',
                }}
              />
              <div
                style={{
                  position: 'absolute', left: 121, top: 0, width: 120, height: 120,
                  backgroundColor: 'var(--neutral-colors-linegray300)',
                }}
              />
              <div
                style={{
                  position: 'absolute', left: 121, top: 121, width: 120, height: 120,
                  backgroundColor: 'var(--neutral-colors-linegray300)',
                }}
              />
            </div>
              ...
              <div style={{ marginLeft: 0, paddingTop: 10 }}>
                ...
                >
                  ...
                  <div style={{ position: 'relative', width: 14, height: 15, flexShrink: 0 }}>
                    ...
                    >
                      <path fillRule="evenodd" clipRule="evenodd" d="M12.1965 12.1969C9.67402 14.6022 4.32685 14.6022 1.80436 12.1969C-0.601454 9.67363 -0.601454 4.32724 1.80436 1.80401C4.32685 -0.601338 9.67285 -0.601338 12.1965 1.80401C14.6012 4.32724 14.6012 9.67363 12.1965 12.1969Z" fill="#06C755" />
                    </svg>
                    ...
                    <svg
                      ...
                      style={{ position: 'absolute', left: 0, top: 1 }}
                    >
                      <path d="M7 0.25C8.9224 0.25 10.8177 0.838047 12.0195 1.98047C13.1618 3.182 13.7499 5.07731 13.75 7C13.75 8.9226 13.1616 10.8179 12.0195 12.0195C10.8183 13.1622 8.92282 13.751 7 13.751C5.07709 13.7509 3.1816 13.1624 1.98047 12.0195C0.838046 10.8179 0.25 8.92236 0.25 7C0.250089 5.07755 0.837846 3.18202 1.98047 1.98047C3.18172 0.837777 5.07733 0.25 7 0.25Z" stroke="black" strokeOpacity="0.05" strokeWidth="0.5" />
                    </svg>
                    ...
                    >
                      <path fillRule="evenodd" clipRule="evenodd" d="M3.37482 6.75049C2.69883 6.75049 2.02732 6.71015 1.37943 6.62951C0.720148 6.54843 0.20267 6.03057 0.120944 5.37112C0.0407398 4.72283 0 4.0514 0 3.37524C0 2.69908 0.0407398 2.02762 0.120944 1.37936C0.202629 0.719915 0.720148 0.202062 1.37923 0.120974C2.02736 0.0402971 2.69883 0 3.37482 0C4.05081 0 4.72232 0.0403383 5.37021 0.120974C6.02949 0.202062 6.54697 0.719915 6.6287 1.37936C6.7089 2.02766 6.74964 2.69908 6.74964 3.37524C6.74964 4.0514 6.7089 4.72287 6.6287 5.37112C6.54701 6.03057 6.02949 6.54843 5.37041 6.62951C4.72232 6.71015 4.05081 6.75049 3.37482 6.75049Z" fill="white" />
                      <path fillRule="evenodd" clipRule="evenodd" d="M3.34561 2.22177C3.26848 2.0892 3.07699 2.0892 2.99986 2.22177L1.66217 4.52109C1.5846 4.65442 1.68079 4.82166 1.83504 4.82166H4.51042C4.66468 4.82166 4.76087 4.65442 4.6833 4.52109L3.34561 2.22177Z" fill="#06C755" />
                      <path fillRule="evenodd" clipRule="evenodd" d="M5.21919 2.0969C5.21919 2.40065 4.97323 2.64696 4.6699 2.64696C4.36657 2.64696 4.12061 2.40065 4.12061 2.0969C4.12061 1.79315 4.36657 1.54746 4.6699 1.54746C4.97323 1.54746 5.21919 1.79315 5.21919 2.0969" fill="#06C755" />
                    </svg>
                  </div>
    ...
    <div style={{ paddingLeft: 44, paddingBottom: 7, marginTop: 7 }}>
      ...
      >
        {/* Row1: Row2(CHECK + text) + ico_4 chevron, space-between */}
        <div
          style={{
            flex: 1,
            display: 'flex',
        ...
        >
          {/* Row2: green CHECK badge + text */}
          <div style={{ display: 'flex', flexDirection: 'row', alignItems: 'center', gap: 5 }}>
            {/* lyp_nomemver_label — green pill, cornerRadius:29 */}
            <div
              style={{
                height: 15,
            ...
            {/* "動画を追加する方法をチェック" — fontSize:11, W4, white */}
            <span
              style={{
                fontFamily: 'var(--font-family-font-family-text-ios)',
                fontSize: 'var(--font-size-ios-font-size-text-11)',
          ...
          <svg width="9" height="11" viewBox="0 0 9 11" fill="none" xmlns="http://www.w3.org/2000/svg">
            <g opacity="0.5">
              <path d="M3.5 9.35053L7.35104 5.49949L3.5 1.64948" stroke="white" strokeWidth="1.3" />
            </g>
          </svg>
        </div>
      </div>
